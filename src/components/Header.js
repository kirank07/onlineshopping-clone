...
import onlineshoplogo from '../../src/assets/img/onlineshoplogo.jpg';
  ...
  return (
    <div className="bg-white">
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-pink-300 px-4 text-sm font-medium text-black sm:px-6 lg:px-8">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="relative pl-24">
                <input
                    ...
                    name="search"
                    id="search"
                    className="block w-96 rounded-lg border-0 py-1.5 pl-7 pr-20 text-gray-200 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-inset focus:ring-pink-300 sm:text-sm sm:leading-6"
                    placeholder="Search for products, brands and more..."
                />
                <MagnifyingGlassIcon className="h-6 w-6 absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-400" aria-hidden="true" />
